  ...
  <script src="{{ asset('js/template.js') }}"></script>
  <script src="{{ asset('js/template.js') }}"></script>
  <script src="{{ asset('js/fontawesome/js/all.min.js') }}"></script>
  <!-- endinject -->
  <!-- plugin js for this page -->
  <script src="{{ asset('regal/vendors/chart.js/Chart.min.js') }}"></script>
  <script src="{{ asset('regal/vendors/jquery-bar-rating/jquery.barrating.min.js') }}"></script>
  <!-- End plugin js for this page -->
